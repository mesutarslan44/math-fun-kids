...
import { getCipherLevelsWithStatus } from '../utils/CipherManager';
import { playSelection, playFailure } from '../utils/SoundManager';

const CipherLevelScreen = ({ navigation }) => {
    const [levels, setLevels] = useState([]);
    const [loading, setLoading] = useState(true);

    const loadLevels = async () => {
        setLoading(true);
        const data = await getCipherLevelsWithStatus();
        setLevels(data);
        setLoading(false);
    };
    ...
    const handleLevelPress = (level) => {
        ...
        playSelection();
        navigation.navigate('CipherGame', { levelId: level.id });
    };
        ...
        <Layout>
            <View style={styles.header}>
                ...
                <View style={styles.titleSection}>
                    ...
                    <Text style={styles.title}>Şifreleme</Text>
                </View>
            ...
            <Text style={styles.subtitle}>🧩 Soyut Düşünme</Text>
            <Text style={styles.description}>
                Sembolleri çöz, şifreleri kır!
            </Text>
...
export default CipherLevelScreen;
