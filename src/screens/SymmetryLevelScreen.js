...
import { Flip, Lock, Star, ChevronRight, Trophy } from 'lucide-react-native';
import Layout from '../components/Layout';
import theme from '../constants/theme';
import { getSymmetryLevelsWithStatus } from '../utils/SymmetryManager';
import { playSelection, playFailure } from '../utils/SoundManager';

const SymmetryLevelScreen = ({ navigation }) => {
    const [levels, setLevels] = useState([]);
    const [loading, setLoading] = useState(true);

    const loadLevels = async () => {
        setLoading(true);
        const data = await getSymmetryLevelsWithStatus();
        setLevels(data);
        setLoading(false);
    };
    ...
    const handleLevelPress = (level) => {
        ...
        playSelection();
        navigation.navigate('SymmetryGame', { levelId: level.id });
    };
        ...
        <Layout>
            <View style={styles.header}>
                ...
                <View style={styles.titleSection}>
                    ...
                    <Text style={styles.title}>Yansıma</Text>
                </View>
            ...
            <Text style={styles.subtitle}>🔄 Uzamsal Algı</Text>
            <Text style={styles.description}>
                Ayna görüntüsünü bul, simetriyi anla!
            </Text>
                        ...
                        <View style={styles.levelLeft}>
                            ...
                            <View style={styles.levelInfo}>
                                ...
                                <Text style={[
                                    ...
                                    {level.description} • {level.gridSize}x{level.gridSize} grid
                                </Text>
...
export default SymmetryLevelScreen;
